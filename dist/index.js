...
const allowedUsers = userConfig.allowed_users;
const LOG_CHANNEL_ID = process.env.LOG_CHANNEL_ID;
if (!LOG_CHANNEL_ID)
    throw new Error('❌ LOG_CHANNEL_ID manquant dans .env');
...
client.on('interactionCreate', async (interaction) => {
    if (!interaction.isChatInputCommand())
        return;
    const typedInteraction = interaction;
    if (typedInteraction.commandName !== 'upload')
        return;
