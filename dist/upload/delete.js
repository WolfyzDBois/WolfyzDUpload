...
export const command = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await sendLogEmbed(interaction, '🗑️ File Deleted', `File \`${filename}\` was deleted by <@${userId}>.`, 0xe67e22);
        }
        catch (err) {
            ...
            await sendLogEmbed(interaction, '❌ Deletion Failed', `An error occurred while <@${userId}> tried to delete \`${filename}\`.`, 0xe74c3c);
        }
        finally {
            ftp.close();
        }
