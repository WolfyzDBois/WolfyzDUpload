...
export const command = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt => opt.setName('fichier').setDescription('Upload a file').setRequired(false))
        .addStringOption(opt => opt.setName('lien').setDescription('Upload a file by URL').setRequired(false))
        .addStringOption(opt => opt.setName('name').setDescription('Custom filename (no extension)').setRequired(false)),
