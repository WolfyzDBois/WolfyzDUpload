...
export const command = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await sendLogEmbed(interaction, '🗑️ Redirection Deleted', `<@${userId}> deleted redirect \`${name}\``, 0xe67e22);
        }
        catch (err) {
            ...
            await sendLogEmbed(interaction, '❌ Redirection Deletion Failed', `Failed attempt by <@${userId}> to delete redirect \`${name}\``, 0xe74c3c);
        }
        finally {
            ftp.close();
        }
